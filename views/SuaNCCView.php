        ...
        <div class="content-wrapper" style="min-height: 639px;">
            <section class="content-header">
                ...
                <div class="breadcrumb">
                    <a class="btn btn-primary btn-sm" href="NhaCungCapController" role="button">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tenncc" style="width:100%"
                                        placeholder="Tên nhà cung cấp" value="Apple">
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6" style="padding-right: 0px;">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="sdtncc" style="width:100%"
                                                    placeholder="SĐT nhà cung cấp" value="123456666">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="dcncc" style="width:100%"
                                        ...
                                        value="32 Cách Mạng Tháng 8, P.6, Quận 3, TP HCM">
                                </div>
                                <div class="form-group">
                                    <label>Website</label>
                                    <input type="text" class="form-control" name="wsncc" style="width:100%"
                                        placeholder="Website nhà cung cấp" value="https://www.apple.com.vn/">
                                </div>
                            </div>
                        </div>
                    </div>
