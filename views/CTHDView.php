        ...
        <div class="content-wrapper" style="min-height: 639px;">
            <section class="content-header">
                ...
                <div class="breadcrumb">
                    <a class="btn btn-primary btn-sm" href="HoaDonController" role="button">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4" style="padding-left: 0px;">
                                        <div class="form-group">
                                            ...
                                            <select name="KH_HD_IP" class="form-group" style="width:100%">
                                                <option value>[--Chọn khách hàng--]</option>
                                                <option value="1" selected>1-Nguyễn Văn A</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="MaKM_HD_IP" min="0" step="1"
                                    ...
                                    <div class="col-md-4" style="padding-right: 0px;">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="TTTT_HD_IP">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4" style="padding-left: 0px;">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="TongTien_HD_IP" min="0"
                                                step="5000" style="width:100%" value="30000000">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Tiền nhận</label>
                                            <input type="number" class="form-control" name="TienNhan_HD_IP" min="0"
                                    ...
                                    <div class="col-md-4" style="padding-right: 0px;">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="Tientra_HD_IP" min="0"
                                                step="5000" style="width:100%" value="0">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="box-body">
                                <div class="col-md-6" style="border-right:ridge">
                                    <div class="form-group">
                                        ...
                                        <select name="SP_CTHD_IP" class="form-group" style="width:100%" id="spSL">
                                            <option value>[----Chọn sản phẩm----]</option>
                                            <option value="1">1-Iphone 13 Pro Max</option>
                                            <option value="2">2-Iphone 12 Pro Max</option>
                                        </select>
                                        <label>Số lượng</label>
                                        <input type="number" class="form-control" id="slIP" name="SL_CTHD_IP" min="0"
