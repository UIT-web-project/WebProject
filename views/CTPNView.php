                                                ...
                                                <?php 
													foreach ($arrResultNCC as $item) :
														if($item['MaNCC'] == $arrResultPN[0]['MaNCC']) 
															echo "<option value='". $arrResultPN[0]['MaNCC']."' selected>".$item['TenNCC']."</option>";
														else echo "<option value='". $item['MaNCC']."'>".$item['TenNCC']."</option>";
													endforeach 
												?>
                                            </select>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-6" style="padding-left: 0px;">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="thanhtien" min="0"
                                    ...
                                    <div class="col-md-6" style="padding-right: 0px;">
                                        <div class="form-group">
                                            ...
                                            <select name="nhanvien" class="form-group" style="width:100%">
                                                <?php 
                            ...
                            <div class="box-body">
                                <div class="col-md-6" style="border-right:ridge">
                                    <div class="form-group">
                                        ...
                                        <select name="sanpham" class="form-group" style="width:100%" id="sanpham">
                                            <?php 
