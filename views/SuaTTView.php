                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" style="width:100%"
                                            ...
                                            value="Bất chấp lệnh cấm, doanh số smartphone của Huawei vẫn tăng 130% ở Trung Quốc">
                                    </div>
                                    <div class="form-group">
                                        <label>Link bài viết</label>
                                        <textarea name="introtext"
                                            class="form-control">https://fptshop.com.vn/tin-tuc/tin-moi/amp/bat-chap-lenh-cam-doanh-so-smartphone-cua-huawei-van-tang-130-o-trung-quoc-84115</textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
