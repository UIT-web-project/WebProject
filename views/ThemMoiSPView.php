                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-6" style="padding-left: 0px;">
                                                    ...
                                                    <label for="vehicle1" style="font-weight: 200; margin-right: 50;">
                                                        HCM</label>
                                                    <input type="checkbox" id="vehicle2" name="vehicle2">
                                                    <label for="vehicle2" style="font-weight: 200; margin-right: 50;">
                                                        Hà Nội</label>
                                                ...
                                                <div class="col-md-6" style="padding-right: 0px;">
                                                    ...
                                                    <input name="soluong" class="form-control" type="number" value="0"
                                                        min="0" step="1">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="col-md-6" style="padding-left: 0px;">
                                                    <div class="form-group">
                                                        <label>Ram</label>
                                                        <input name="ram" class="form-control" type="number" value="0"
                                                ...
                                                <div class="col-md-6" style="padding-right: 0px;">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="rom" class="form-control" type="number" value="0"
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-6" style="padding-left: 0px;">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="pin" class="form-control" type="number" value="0"
                                                ...
                                                <div class="col-md-6" style="padding-right: 0px;">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="disp" class="form-control" type="number" value="0"
