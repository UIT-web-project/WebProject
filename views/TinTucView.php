                                            ...
                                            <table class="table table-hover table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="img/huawei-hongmeng-os_800x450.jpg"
                                                                alt="Bất chấp lệnh cấm, doanh số smartphone của Huawei vẫn tăng 130% ở Trung Quốc"
                                                                class="img-responsive">
                                                        </td>
                                                        <td>Bất chấp lệnh cấm, doanh số smartphone của Huawei vẫn tăng
                                                            130% ở Trung Quốc</td>
                                                        ...
                                                        <td class="text-center">
                                                            <a class="btn btn-success btn-xs" href="SuaTTController"
                                                                role="button">
                                                                <span class="glyphicon glyphicon-edit"></span>Sửa
                                                            </a>
                                                        </td>
                                                        <td class="text-center">
                                                            <a class="btn btn-danger btn-xs" href="TinTucController"
