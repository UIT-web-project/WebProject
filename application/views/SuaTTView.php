...
<body class="skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <form class="content-wrapper" style="min-height: 639px;"
            action="<?php echo base_url() ?>index.php/SuaTTController/SuaTinTuc/?id=<?php echo $arrResult[0]['id'] ?>"
            method="post" enctype="multipart/form-data">
            <section class="content-header">
                <h1><i class="glyphicon glyphicon-book"></i> Cập nhật bài viết</h1>
                <div class="breadcrumb">
                    <a class="btn btn-primary btn-sm" href="<?php echo base_url() ?>index.php/TinTucController"
                        role="button">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="tieude" style="width:100%"
                                            placeholder="Tên bài viết" value="<?php echo $arrResult[0]['tieude'] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Mô tả</label>
                                        <textarea name="mota" class="form-control"
                                            style="height: 8vh;"><?php echo $arrResult[0]['mota'] ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Nội dung</label>
                                        <textarea name="noidung" class="form-control"
                                            style="height: 50vh;"><?php echo $arrResult[0]['noidung'] ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <img style="width: 200px; height: 200px;"
                                            src="<?php echo $arrResult[0]['hinhanh'] ?>" alt="">
