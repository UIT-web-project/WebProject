                                    ...
                                    <div class="col-md-8" style="border-right: ridge;">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name" style="width:100%"
                                                placeholder="Tên sản phẩm" value="Iphone 13 Pro Max">
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6" style="padding-right: 0px;">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="sortDesc" class="form-control"
                                                            style="height: 85px;">Không</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-6" style="padding-left: 0px;">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="price" class="form-control" type="number"
                                                            value="30000000" min="0" step="5000">
                                                    </div>
                                                </div>
                                                <div class="col-md-6" style="padding-right: 0px;">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="price_dis" class="form-control" type="number"
                                                            value="27000000" min="0" step="5000">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="col-md-6" style="padding-left: 0px;">
                                                    <label>Kho</label><br>
                                                    <input type="checkbox" id="hcm" name="hcm" checked>
                                                    <label for="hcm" style="font-weight: 200; margin-right: 50;">
                                                        HCM</label>
                                                    <input type="checkbox" id="hanoi" name="hanoi">
                                                    <label for="hanoi" style="font-weight: 200; margin-right: 50;"> Hà
                                                        Nội</label>
                                                    <input type="checkbox" id="danang" name="danang">
                                                    <label for="danang" style="font-weight: 200;"> Đà Nẵng</label>
                                                </div>
                                                <div class="col-md-6" style="padding-right: 0px;">
                                                    <label>Số lượng</label>
                                                    <input name="soluong" class="form-control" type="number" value="100"
                                                        min="0" step="1">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="col-md-6" style="padding-left: 0px;">
                                                    <div class="form-group">
                                                        <label>Ram</label>
                                                        <input name="ram" class="form-control" type="number" value="6"
                                                ...
                                                <div class="col-md-6" style="padding-right: 0px;">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="rom" class="form-control" type="number" value="256"
                                                ...
                                                <div class="col-md-6" style="padding-left: 0px;">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="pin" class="form-control" type="number"
                                                            value="4352" min="0" max="100000" step="1">
                                                    </div>
                                                </div>
                                                <div class="col-md-6" style="padding-right: 0px;">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="disp" class="form-control" type="number"
                                                            value="6.7" min="0" max="100" step="0.1">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
