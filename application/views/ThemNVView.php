...
<body class="skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <form class="content-wrapper" style="min-height: 639px;"
            action="<?php echo base_url() ?>index.php/ThemNVController/ThemNV" method="post">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-6" style="padding-left: 0px;">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" name="ngayvl"
                                                    style="width:100%">
                                            </div>
                                        </div>
                                        <div class="col-md-6" style="padding-right: 0px;">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="luong"
                                                    style="width:100%" placeholder="Lương nhân viên" value="0" min="0">
                                            </div>
                                        </div>
                                    </div>
                                </div>
