                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a class="btn btn-info btn-xs"
                                                                href="<?php echo base_url() ?>index.php/XemKHController/?makh=<?php echo $item['MaKH'] ?>"
                                                                role="button">
                                                        ...
                                                        <td class="text-center">
                                                            <a class="btn btn-danger btn-xs"
                                                                href="<?php echo base_url() ?>index.php/KhachHangController/XoaKH/?makh=<?php echo $item['MaKH'] ?>"
