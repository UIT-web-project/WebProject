                    ...
                    <div class="col-md-12">
                        <div class="box" id="view">
                            <div class="box-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4" style="padding-left: 0px;">
                                            <div class="form-group">
                                                ...
                                                <input type="number" readonly class="form-control" name="makh"
                                                    style="width:100%" value="<?php echo $arrResult[0]['MaKH']?>"
                                                    min="0" step="1">
                                            </div>
                                        </div>
                                        <div class="col-md-8" style="padding-right: 0px;">
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly class="form-control" name="tenkh"
                                                    style="width:100%" placeholder="Tên khách hàng"
                                                    value="<?php echo $arrResult[0]['TenKH']?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-5" style="padding-left: 0px;">
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly class="form-control" name="sdt"
                                                    style="width:100%" placeholder="SĐT khách hàng"
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4" style="padding-left: 0px;">
                                            <div class="form-group">
                                                ...
                                                <select name="gtkhIP" class="form-group"
                                                    style="width:100%;padding: 7px;" disabled>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>CMND</label>
                                                <input type="text" readonly class="form-control" name="cmnd"
                                ...
                                <div class="form-group">
                                    <label>Địa chỉ</label>
                                    <input type="text" readonly class="form-control" name="diachi" style="width:100%"
                                        placeholder="Địa Chỉ khách hàng" value="<?php echo $arrResult[0]['DiaChi']?>">
                                </div>
                            </div>
                        </div>
