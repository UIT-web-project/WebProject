						...
						echo "
							<div class='col-sm-1'>
								<div class='shopping-item'>
									...
									<span class='product-count'>".$this->session->userdata('soluongmua')."</span>
									</a>
								</div>
							</div>
				";
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-price-ct">
                                                <span class="amount"><?php echo $item['Gia'] ?> đ</span>
                                            </td>
                                                    ...
                                                    <select name="makm" id="makm">
                                                        <?php 
															foreach ($arrResultKM as $item) : 
																echo "<option value='".$item['MaKM']."'>".$item['SoPTKM']." %</option>";
															endforeach;
														?>
                                                    </select>
                                                </div>
