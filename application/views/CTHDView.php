        ...
        <div class="content-wrapper" style="min-height: 639px;">
            <section class="content-header">
                ...
                <div class="breadcrumb">
                    <a class="btn btn-primary btn-sm" href="<?php echo base_url()?>index.php/HoaDonController"
                        role="button">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-2" style="padding-left: 0px;">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="mahd" style="width:100%"
                                                value="<?php echo $arrResult[0]['MaHD']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="makh" min="0"
                                                style="width:100%" value="<?php echo $arrResult[0]['SoPTKM']?>">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4" style="padding-left: 0px;">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="tongtientt" min="0"
                                                style="width:100%" value="<?php echo $arrResult[0]['TongTienTT']?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Tiền nhận</label>
                                            <input type="number" class="form-control" name="tiennhan" min="0"
                                                style="width:100%" value="<?php echo $arrResult[0]['SoTienNhan']?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4" style="padding-right: 0px;">
                                        <div class="form-group">
                                            <label>Tiền trả</label>
                                            <input type="number" class="form-control" name="tientra" min="0"
                                                style="width:100%" value="<?php echo $arrResult[0]['SoTienTra']?>">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="box-body">
                                <div class="col-md-6" style="border-right:ridge">
                                    <div class="form-group">
                                        ...
                                        <select name="SP_CTHD_IP" class="form-group" style="width:100%; padding: 7px"
                                            id="sanpham">
                                            <option value="<?php echo $arrResult[0]['masp']?>">
                                                <?php echo $arrResult[0]['tensp']?></option>
                                        </select>
                                        <label>Số lượng</label>
                                        <input type="number" class="form-control" id="slIP" name="soluong" min="0"
                                            style="width:100%; padding: 7px; margin-bottom: 10;"
                                            value="<?php echo $arrResult[0]['SoLuong']?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Ngày lập hóa đơn</label>
                                        <input type="date" class="form-control" id="slIP" name="soluong" min="0"
                                            style="width:100%; padding: 7px; margin-bottom: 10;"
                                            value="<?php echo $arrResult[0]['NgayLapHD']?>">
                                        <label>Thành tiền</label>
                                        <input type="number" class="form-control" id="slIP" name="thanhtien" min="0"
                                            style="width:100%; padding: 7px; margin-bottom: 10;"
                                            value="<?php echo $arrResult[0]['ThanhTien']?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <table class="table">
