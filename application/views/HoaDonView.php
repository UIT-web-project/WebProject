                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a class="btn btn-danger btn-xs"
                                                                href="<?php echo base_url()?>index.php/HoaDonController/XoaHD/?mahd=<?php echo $item['MaHD']?>&tttt=<?php echo $item['TinhTrangTT']?>&ttgh=<?php echo $item['TinhTrangGH']?>"
                                                                onclick="return confirm('Xác nhận xóa hóa đơn này ?')"
                                                                role="button">
                                            ...
                                            <div class="col-md-12 text-center">
                                                <ul class="pagination">
                                                    <li class="hidden-xs"><a
                                                            href="<?php echo base_url() ?>index.php/HoaDonController/index/<?php echo 1 ?>">Trang
                                                            đầu</a></li>
                                                    <?php for ($i=0 ; $i < $SoTrang ; $i++ ) : ?>
                                                    <li class=""><a
                                                            href="<?php echo base_url() ?>index.php/HoaDonController/index/<?php echo $i+1 ?>"><?php echo $i+1 ?></a>
                                                    </li>
                                                    <?php endfor?>
                                                    <li class="hidden-xs"><a
                                                            href="<?php echo base_url() ?>index.php/HoaDonController/index/<?php echo $SoTrang ?>">Trang
                                                            cuối</a></li>
                                                </ul>
                                            </div>
                                        </div>
